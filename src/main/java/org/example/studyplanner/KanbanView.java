...
public class KanbanView {
    ...
    private String renderKanban() {
        StringBuilder sb = new StringBuilder();
        sb.append(renderSection(State.TODO, "Material ToDo"));
        sb.append(renderSection(State.DOING, "Material in progress"));
        sb.append(renderSection(State.DONE, "Material completed"));
        return sb.insert(0, "[ ").append("]").toString();
    }

    private String renderSection(State state, String header) {
        StringBuilder sb = new StringBuilder();
        sb.append(header).append(":").append(System.lineSeparator());
        sb.append(renderMaterials(kanban.get(state)));
        sb.append(System.lineSeparator());
        return sb.toString();
    }

    private String renderMaterials(List<PlannerMaterial> materials) {
