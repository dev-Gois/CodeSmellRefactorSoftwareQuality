...
public class StudyPlannerController {
    ...
    private void handleAddHabit() {
        ...
        habitTracker
                .startNewHabit(name, motivation)
                .withDedicationTime(dailyHoursDedication, dailyMinutesDedication)
                .startingOn(start.getYear(), start.getMonthValue(), start.getDayOfMonth(),
